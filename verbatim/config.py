...
TEMPLATE = {
    "_doc": "Configuration for the verbatim legal-citation toolkit. Paths are relative to this file.",
    ...
    "_citation_packs": "Which bodies of law you cite. Run `verbatim packs` to list what ships.",
    "citation_packs": ["us-federal"],
...
class Config(object):
    ...
    def cache(self):
        ...
        if c:
            return self.abs(c)
        import tempfile
        return os.path.join(tempfile.gettempdir(), "verbatim-corpus-cache")
