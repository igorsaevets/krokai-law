...
_STAMP_TXT = ("# %s : field dump written by `krokai form-dump`. NOT a primary source; values "
              "here must never verify as law.\n" % SENTINEL)
_STAMP_MD = ("<!-- %s : generated by `krokai form-dump`. Not a primary source. -->\n" % SENTINEL)
